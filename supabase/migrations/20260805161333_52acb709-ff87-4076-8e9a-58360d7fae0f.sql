...
REVOKE EXECUTE ON FUNCTION public.calc_revenue_commission() FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.validate_release_splits_total() FROM PUBLIC, anon, authenticated;
